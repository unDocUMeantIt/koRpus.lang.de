#' Language Support for 'koRpus' Package: German.
#'
#' \tabular{ll}{
#' Package: \tab koRpus.lang.de\cr
#' Type: \tab Package\cr
#' Version: \tab 0.1-2\cr
...
#'
#' @aliases koRpus.lang.de-package
#' @name koRpus.lang.de-package
#' @docType package
#' @title The koRpus.lang.de Package
