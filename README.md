...
```r
devtools::install_github("unDocUMeantIt/koRpus.lang.de") # stable release
devtools::install_github("unDocUMeantIt/koRpus.lang.de", ref="develop") # development release
```
...
koRpus.lang.de Copyright (C) 2018-2020 Meik Michalke, released under the
